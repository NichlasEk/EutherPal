...
- TV: <http://127.0.0.1:8791/tv>
- Mobil: <http://127.0.0.1:8791/mobile>
- Admin: <http://127.0.0.1:8791/admin>
- Health: <http://127.0.0.1:8791/health>

For LAN-test:

```sh
EUTHERPAL_BIND=0.0.0.0:8791 cargo run --manifest-path server/Cargo.toml
```
